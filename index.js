...
const congratsElements = () => {
  ...
  callNowBtn.style.width = "90%";
  callNowBtn.style.marginLeft = "auto";
  callNowBtn.style.marginRight = "auto";
  callLink.href = "tel:(888) 227-7051";
  callLink.appendChild(callNowBtn);
...
<h3 style="text-align: center">Call before enrollment closes!</h3>`;
  ...
  document.querySelector(".buttons").appendChild(callLink);
